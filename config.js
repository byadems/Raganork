...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'WhatsAsena;https://i.hizliresim.com/6Bbj7i.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'WindAndro' : process.env.OWNER_NAME,
    ...
    warn_count: process.env.WARN === undefined ? '3' : process.env.WARN,
    ...
    SUPPORT: process.env.ASENA === undefined ? '120363025552874144' : process.env.ASENA,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'LADES-Bot' : process.env.STICKER_DATA,
    ...
    TAGALL: process.env.TAG_HEADER === undefined ? '*[TOPLU ETİKET]*' : process.env.TAG_HEADER,
    ...
    sourav_g_link: process.env.GROUP_LINK === undefined ? '' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
